...
class UpdateServiceRequest extends FormRequest
{
    ...
    {
        return [
            'title.*' => 'required', 'string', 'max:255', UniqueTranslationRule::for('services')->ignore($this->id),
            'slug.*' => 'required', 'string', 'max:255', UniqueTranslationRule::for('services')->ignore($this->id),
