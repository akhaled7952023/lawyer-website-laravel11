...
class UpdateArticleRequest extends FormRequest
{
    ...
    {
        return [
            'title.*' => 'required', 'string', 'max:255', UniqueTranslationRule::for('articles')->ignore($this->id),
            'slug.*' => 'required', 'string', 'max:255', UniqueTranslationRule::for('articles')->ignore($this->id),
