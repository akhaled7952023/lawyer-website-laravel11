...
<link rel="stylesheet" type="text/css" href="{{asset('asset/dashboard')}}/vendors/css/editors/summernote.css">
<link rel="stylesheet" href="{{asset('asset/dashboard')}}/vendors/dropify/dropify.min.css">
