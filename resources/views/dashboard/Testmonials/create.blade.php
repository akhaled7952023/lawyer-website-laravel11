                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ __('dashboard.create_testmonials') }}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form id="myForm" class="form" action="{{ route('dashboard.testimonials.store') }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf

                                <div class="form-body">
                                    <h4 class="form-section"><i class="la la-new"></i>{{ __('dashboard.create_testmonials') }}</h4>
                                    <div class="row">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
                                                <div class="custom-file">
                                                    ...
                                                    style="resize: none;" rows="6">{{ old('feedback_ar') }}</textarea>
                                                    @error('feedback_ar')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
                                                <div class="custom-file">
                                                    ...
                                                    style="resize: none;" rows="6">{{ old('feedback_en')}}</textarea>
                                                    @error('feedback_en')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
