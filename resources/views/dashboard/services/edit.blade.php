                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ __('dashboard.edit_services') }}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form id="myForm" class="form" action="{{ route('dashboard.services.update', $service->id) }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="form-body">

                                    <h4 class="form-section"><i class="la la-new"></i>{{ __('dashboard.edit_services') }}</h4>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" id="status-input" name="status" value="{{ $service->status ?? 1 }}">
                                                @error('status')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="userinput1" class="form-control border-primary"
                                                    name="title[ar]" value="{{$service->getTranslation('title', 'ar')}}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="userinput1" class="form-control border-primary"
                                                    name="title[en]" value="{{$service->getTranslation('title', 'en')}}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="slug_ar" class="form-control border-primary"
                                                    name="slug[ar]" value="{{$service->getTranslation('slug', 'ar')}}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="slug_en" class="form-control border-primary"
                                                    name="slug[en]" value="{{$service->getTranslation('slug', 'en')}}"
                                        ...
                                        <div class="col-md-12">
                                            <fieldset class="form-group" >
                                                <div class="custom-file"  >
                                                    ...
                                                    <textarea id="summernote_ar"  class="summernote" name="description_ar" class="form-control">
                                        ...
                                        <div class="col-md-12">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="file" name="image" id="image"
                                                    ...
                                                    data-default-file="{{ asset('uploads/general/' . $service->image) }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="userinput1" class="form-control border-primary"
                                                    name="meta_keywords_ar"  value="{{$service->getTranslation('meta_keywords', 'ar')}}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="userinput1" class="form-control border-primary"
                                                   ...
                                                   value="{{$service->getTranslation('meta_keywords', 'en')}}"
