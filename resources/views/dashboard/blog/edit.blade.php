                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ __('dashboard.edit_article') }}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form id="myForm" class="form" action="{{ route('dashboard.blog.update', $blog->id) }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                @method('PUT')

                                <div class="form-body">
                                    <h4 class="form-section"><i class="la la-new"></i>{{ __('dashboard.edit_article') }}</h4>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group" style="margin-top: 20px">
                                                ...
                                                <input type="hidden" id="status-input" name="status" value="{{ $blog->status ?? 1 }}">
                                                @error('status')
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="userinput1" class="form-control border-primary"
                                                    name="title[ar]"  value="{{ old('title_ar', $blog->getTranslation('title', 'ar')) }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="userinput1" class="form-control border-primary"
                                                    name="title[en]"  value="{{ old('title_ar', $blog->getTranslation('title', 'en')) }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="slug_ar" class="form-control border-primary"
                                                    name="slug[ar]"  value="{{ old('title_ar', $blog->getTranslation('slug', 'ar')) }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="slug_en" class="form-control border-primary"
                                                    name="slug[en]" value="{{ old('title_ar', $blog->getTranslation('slug', 'en')) }}"
                                            ...
                                            <fieldset class="form-group">
                                                <div class="custom-file">
                                                    ...
                                                    <textarea name="content_ar" id="ckeditor_ar" cols="30" rows="15" class="ckeditor-config">
                                                        {!! old('content_ar', $blog->getTranslation('content', 'ar')) !!}
                                                    </textarea>
                                                    @error('content_ar')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                            ...
                                            <fieldset class="form-group">
                                                <div class="custom-file">
                                                    ...
                                                    <textarea name="content_en" id="ckeditor_en" cols="30" rows="15" class="ckeditor-config">
                                                        {!! old('content_en', $blog->getTranslation('content', 'en')) !!}
                                                    </textarea>
                                                    @error('content_en')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="metatitlear"
                                                    ...
                                                    value="{{ old('meta_title_ar', $blog->getTranslation('meta_title', 'ar')) }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="metatitleen"
                                                    ...
                                                    value="{{ old('meta_title_en', $blog->getTranslation('meta_title', 'en')) }}"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="metadescriptionar"
                                                    ...
                                                    value="{{ old('meta_description_ar', $blog->getTranslation('meta_description', 'ar')) }}"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="metadescriptionen"
                                                    ...
                                                    value="{{ old('meta_description_en', $blog->getTranslation('meta_description', 'en')) }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="userinput1" class="form-control border-primary"
                                                    ...
                                                    value="{{ old('meta_keywords_ar', $blog->getTranslation('meta_keywords', 'ar')) }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="userinput1" class="form-control border-primary"
                                                    ...
                                                    value="{{ old('meta_keywords_en', $blog->getTranslation('meta_keywords', 'en')) }}"
