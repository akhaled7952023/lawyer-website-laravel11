                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a>{{ __('dashboard.faq') }}</a>
                                </li>
            ...
            <div class="content-body">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <a href="{{ route('dashboard.faq.create') }}" class="btn btn-primary">{{ __('dashboard.create_faq') }}</a><br><br>
                            <a href="{{ route('dashboard.faqdetails.index') }}" class="btn btn-primary">{{ __('dashboard.faq_imageandtitle') }}</a><br><br>
                            ...
                            <table class="table table-responsive-sm">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">{{ __('dashboard.status_faq') }} </th>
                                ...
                                <tbody>
                                    ...
                                    @forelse ($faq as $faqq)
                                                ...
                                                <div class="dropdown float-md-left">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdmanagersownBreadcrumbButton">
                                                        <a class="dropdown-item"
                                                            href="{{ route('dashboard.faq.edit', $faqq->id) }}"><i
                                                                class="la la-edit"></i>{{ __('dashboard.edit') }}</a>

                                                        <div class="dropdown-divider"></div><a class="dropdown-item"
                                                            href="javascript:void(0)"
                                                            onclick="if(confirm('{{ __('dashboard.delete_faq') }}')){document.getElementById('delete-form-{{ $faqq->id }}').submit();} return false"><i
                                        ...
                                        {{-- delete form  --}}
                                        <form id="delete-form-{{ $faqq->id }}"
                                            action="{{ route('dashboard.faq.destroy', $faqq->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
                                        </form>
