                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form id="myForm" class="form" action="{{ route('dashboard.faq.update', $faq->id) }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" id="status-input" name="status" value="{{ $faq->status ?? 1 }}">
                                                @error('status')
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="userinput1" class="form-control border-primary"
                                                    name="question_ar" value="{{$faq->getTranslation('question', 'ar')}}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="userinput1" class="form-control border-primary"
                                                    name="question_en" value="{{$faq->getTranslation('question', 'en')}}"
                                        ...
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
                                                <div class="custom-file">
                                                    ...
                                                    style="resize: none;" rows="6">{{$faq->getTranslation('answer', 'ar')}}</textarea>
                                                    @error('answer_ar')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
                                                <div class="custom-file">
                                                    ...
                                                    style="resize: none;" rows="6">{{$faq->getTranslation('answer', 'en')}}</textarea>
                                                    @error('answer_en')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
