                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ __('dashboard.create_new_member') }}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form id="myForm" class="form" action="{{ route('dashboard.teams.store') }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf

                                <div class="form-body">
                                    <h4 class="form-section"><i
                                            class="la la-new"></i>{{ __('dashboard.create_new_member') }}</h4>
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <fieldset class="form-group">
                                                    <div class="custom-file">
                                                        ...
                                                        <textarea id="summernote_ar" class="summernote" name="bio_ar" >
                                                        {{ old('bio_ar') }}
                                                    </textarea>
                                                        @error('bio_ar')
                                                            <span class="text-danger">{{ $message }}</span>
                                            ...
                                            <div class="col-md-12">
                                                <fieldset class="form-group">
                                                    <div class="custom-file">
                                                        ...
                                                        <textarea id="summernote_en" class="summernote" name="bio_en" class="form-control">
                                                        {{ old('bio_en') }}
                                                    </textarea>
                                                        @error('bio_en')
                                                            <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="userinput1"
                                                        class="form-control border-primary" name="meta_keywords_ar"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="userinput1"
                                                        class="form-control border-primary" name="meta_keywords_en"
